...
1. **Documenten aan het juiste fonds koppelen.** (AFGEROND 2026-08-02) `herstel_nieuwskoppeling.py` loopt nu over beide tabellen; 250 documenten verplaatst. De verwachting dat dit vijf blinde fondsen zou oplossen bleek maar half waar, en de andere helft is leerzaam. APF, KLM Cabine, PME, Fysiotherapeuten en ABP kregen inderdaad hun documenten terug — maar de fondsen die ze afstonden, 64 (Het Nederlandse Pensioenfonds) en 22 (BPFL), hielden er nul over. Hun dekking was altijd al schijn: wat er stond was van een ander. Het aantal blinde fondsen bleef daarom 31, maar de lijst klopt nu. De controle in `check_data_quality.py` kijkt voortaan naar beide tabellen.
2. **De achttien landingspagina's zonder documenten.** (AFGEROND 2026-08-02) De monitor bouwde zijn paden met `urljoin(website_url, '/documenten')`, en een pad dat met een schuine streep begint verwijdert het pad uit `website_url`. Bij een kring met een diepe link werd `stappensioen.nl/financiele-situatie/pensioenkring-2` stilzwijgend `stappensioen.nl/`. De pagina uit `funds.website` staat nu vooraan; dat leverde 44 documenten op bij drie fondsen die er nul hadden.

   Voor de rest bleek mijn probleemstelling niet te kloppen. Zestien van de blinde fondsen hebben allang een analyse: het zijn kringen waarvan het verslag in het koepelverslag zit en daaruit wordt gesneden. Blindheid is alleen een probleem waar het een analyse blokkeert, en dat gold voor elf fondsen, niet tweeendertig. Wolters Kluwer is uit het Hnp-koepelverslag gesneden; TotalEnergies en Pensioenkring 2 zijn rechtstreeks van stappensioen.nl gehaald via het URL-patroon dat de andere Stap-kringen prijsgaven — die bestanden staan er wel maar worden nergens gelinkt.

3. **Horeca & Catering.** (AFGEROND 2026-08-02) Achter een cookiemuur waar alle links naar `#` wijzen tot er toestemming is gegeven, en daarachter een OutSystems-viewer die de PDF pas prijsgeeft via `/rest/DocumentViwer/GetDocument` — met een typefout in hun eigen endpoint. Ingevaren per 1 januari 2026 met een dekkingsgraad van 155,2 procent, en de toeslag van 2,77 procent bewust verleend per 31 december 2025 zodat die nog in de oude aanspraken landde. Vijf jaar historie erbij.

4. **Negen fondsen achter een WAF of onbereikbaar.** (AFGEROND 2026-08-02) De 403's bleken headless-detectie: met een zichtbare browser geeft elk van de negen sites gewoon 200, ook De Nationale APF, dat maandenlang als onbereikbaar gold. Uit hun koepelverslag van 492 pagina's zijn zes kringen gesneden met elk eigen cijfers; drie andere leverden een generieke tekst op en zijn overgeslagen in plaats van gegokt. Pensioenfonds ING publiceert zijn verslag als aparte website met de PDF op een CDN. SNPS en kring AON kwamen er ook bij.

   Twee domeinen bleken niet meer van het fonds: `pensioenfondsafm.nl` is een online casino geworden en `geartesiabank.nl` een commerciele blogsite. Beide staan nu als waarschuwing in de fondsomschrijving, net als `pensioenfondspensura.nl` eerder. GE Artesia is afgevoerd — geen DNB-rijen en geen eigen site meer. Fonds 52 bleek helemaal geen fonds: de naam was een afgekapte categoriebeschrijving uit een scrape.
